...
try:
    ...
    if new_record_type == 'Department':
        ...
        new_empl_joining_date = get_date_value(input('Joining Date:'))
        new_empl_department = get_integer_value(input('Department Name:'))
        new_empl_nationality = input('Nationality:')
        new_empl_passport_number = input('Passport Number:')
        new_empl_passport_expiry_date = get_date_value(input('Passport Expiry Date:'))
        ...
        new_empl_visa_expiry_date = get_date_value(input('UAE Visa Expiry Date:'))
        new_empl_eid_number = get_integer_value(input('Emirates ID Number:'))
        new_empl_eid_expiry_date = get_date_value(input('Emirates ID Expiry Date:'))
        new_empl_phone_company = get_integer_value(input('Company Phone Number:'))
        new_empl_phone_personal = get_integer_value(input('Personal Phone Number:'))
        new_empl_phone_home = get_integer_value(input('Home Phone Number:'))
        ...
        new_empl_dl_expiry_date = get_date_value(input('Drivers License Expiry Date:'))
        new_empl_dl_type = input('Drivers License Type:')
        new_empl_permit_number = input('Permit Number:')
        new_empl_permit_expiry_date = get_date_value(input('Permit Expiry Date:'))
        new_empl_permit_type = input('Permit Type:')
        new_empl_insurance_number = input('Insurance Number:')
        new_empl_insurance_expiry_date = get_date_value(input('Insurance Expiry Date:'))
        ...
        new_empl_monthly_basic_salary = get_integer_value(input('Monthly Basic Salary:'))
        new_empl_monthly_allowance = get_integer_value(input('Monthly Allowance:'))
        new_empl_monthly_accomodation = get_integer_value(input('Monthly Accomodation:'))
        ...
        with engine.begin() as con:
            ...
            'dl_expiry_date': new_empl_dl_expiry_date,
